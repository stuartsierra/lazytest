...
(ns clojure.test-clojure.protocols
  (:use lazytest.deftest clojure.test-clojure.protocols.examples)
...
(deftest protocols-test
  ...
  (testing "you can redefine a protocol with different methods"
    ...
    (is (clojure.test-clojure.helpers/fails-with-cause? IllegalArgumentException #"No method of interface: [a-z-.]+\.Elusive found for function: old-method of protocol: Elusive \(The protocol method may have been defined before and removed\.\)"
...
(deftest illegal-extending
  (testing "you cannot extend a protocol to a type that implements the protocol inline"
    (is (clojure.test-clojure.helpers/fails-with-cause? IllegalArgumentException #".*HasProtocolInline already directly implements interface"
  ...
  (testing "you cannot extend to an interface"
    (is (clojure.test-clojure.helpers/fails-with-cause? IllegalArgumentException #"interface clojure.test_clojure.protocols.examples.ExampleProtocol is not a protocol"
          (eval '(extend clojure.test-clojure.protocols.HasProtocolInline
...
(deftest reify-test
  ...
  (testing "you can't define a method twice"
    (is (clojure.test-clojure.helpers/fails-with-cause?
