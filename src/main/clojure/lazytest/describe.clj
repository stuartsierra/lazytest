...
(defmacro all
  "Defines a group of tests that is generated by a function.

  decl is: sym? doc? attr-map? body*
  ...
  body is expressions, evaluated in a 'do', that must return a
  sequence of test suites or test cases."
  [& decl]
  (let [[sym decl] (get-arg symbol? decl)
	[doc decl] (get-arg string? decl)
